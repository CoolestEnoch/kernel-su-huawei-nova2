...
#define INI_TCXO_MODE           (0)
#define INI_DCXO_MODE           (1)
#define INI_VAR_TCXO_DCXO_MODE  ("tcxo_dcxo_mode")
...
extern int32 read_tcxo_dcxo_mode(void);
