...
/*****************************************************************************
 结构名    : NV_ISIM_ENABLE_STRU
 结构说明  : ISIM是否使能NV

  1.日    期   : 2016年03月11日
    作    者   : z00316370
    修改内容   : PAM_USIM_IT5_ISIM 迭代新增
*****************************************************************************/
typedef struct
{
...
/*****************************************************************************
 结构名    : USIMM_CHECK_KEY_FILE_NV_STRU
 结构说明  : Usim关键文件检测控制NV，NV_ID: 4013 修改后重启生效
...
/*****************************************************************************
 结构名    : USIMM_DISABLE_REAL_ISIM_CTRL_NV_STRU
 结构说明  : 定制功能，控制是否使能真实ISIM应用，默认使能
...
/*****************************************************************************
 结构名    : NV_SC_PERS_IMEI_BIND_SLOT_STRU
 结构说明  : IMEI随卡匹配功能是否开启标记
...
/*****************************************************************************
 结构名    : USIM_CLOSE_CHANNEL_SND_STATUS_STRU
 结构说明  : 关闭通道时，定制是否需要下发status命令,默认下发
 对应NV ID : 4045
...
/*****************************************************************************
结构名    : USIMM_STATUS_PROTECTRESET_CHECKSW_STRU
结构说明  : Status轮询CheckSW异常发起卡保护性复位定制NV
对应NVID:  4072
说明:
  1.日    期   : 2018年3月22日
    作    者   : d00212987
...
/*****************************************************************************
结构名    : USIMM_PLMN_DIGIT_NV_CTRL_STRU
结构说明  : MNC长度异常规避的定制NV
对应NVID  : 4074
说明:
  1.日    期   : 2018年7月6日
