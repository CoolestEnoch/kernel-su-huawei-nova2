...
{
    IMG_UINT32  ui32Reg, ui32I = 0;
    IMG_UINT32 ui32CheckCounter;
...
)
{
    ...
    ui32Reg = 0;
    REGIO_WRITE_FIELD(ui32Reg, IMG_VIDEO_BUS4_MMU, MMU_CONTROL1, MMU_PAUSE_SET, 1);//lint !e845
    REGIO_WRITE_REGISTER(psPvdecContext, IMG_VIDEO_BUS4_MMU, MMU_CONTROL1, ui32Reg);
    ...
    ui32Reg = 0;
    REGIO_WRITE_FIELD(ui32Reg, IMG_VIDEO_BUS4_MMU, MMU_CONTROL1, MMU_SOFT_RESET, 1);//lint !e845
    REGIO_WRITE_REGISTER(psPvdecContext, IMG_VIDEO_BUS4_MMU, MMU_CONTROL1 , ui32Reg);
    /* Wait until MMU_SOFT_RESET -> 0 */
    ui32Result = pvdec_Poll(psPvdecContext,
                            REGION_IMG_VIDEO_BUS4_MMU_REGSPACE,
    ...
    ui32Reg = 0;
    REGIO_WRITE_FIELD(ui32Reg, PVDEC_CORE, CR_PVDEC_SOFT_RESET, CR_PVDEC_SOFT_RESET, 0x1);//lint !e845
    REGIO_WRITE_REGISTER(psPvdecContext, PVDEC_CORE, CR_PVDEC_SOFT_RESET, ui32Reg);//lint !e570
