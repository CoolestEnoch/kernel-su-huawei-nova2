...
/* only for video */
int mipi_jdi_panel_lcd_fps_scence_handle(struct platform_device *pdev, uint32_t scence)
{
	struct hisi_fb_data_type *hisifd = NULL;
	struct hisi_panel_info *pinfo = NULL;
	...
	if ((scence & LCD_FPS_SCENCE_IDLE) == LCD_FPS_SCENCE_IDLE) {
		pinfo->ldi_updt.h_back_porch = 115;
		pinfo->ldi_updt.h_front_porch = 257;
		pinfo->ldi_updt.h_pulse_width = 10;
		pinfo->ldi_updt.v_back_porch = 30;
		pinfo->ldi_updt.v_front_porch = 10;
		pinfo->ldi_updt.v_pulse_width = 10;
		pinfo->fps_updt = 50;
		HISI_FB_DEBUG("scence is LCD_FPS_SCENCE_IDLE, framerate is 50fps\n");
	} else if ((scence & LCD_FPS_SCENCE_VIDEO) == LCD_FPS_SCENCE_VIDEO) {
		pinfo->ldi_updt.h_back_porch = 116;
		pinfo->ldi_updt.h_front_porch = 418;
		pinfo->ldi_updt.h_pulse_width = 10;
		pinfo->ldi_updt.v_back_porch = 30;
		pinfo->ldi_updt.v_front_porch = 10;
		pinfo->ldi_updt.v_pulse_width = 10;
		pinfo->fps_updt = 45;
		HISI_FB_DEBUG("scence is LCD_FPS_SCENCE_VIDEO, framerate is 45fps\n");
	} else {
		pinfo->ldi_updt.h_back_porch = 10;
		pinfo->ldi_updt.h_front_porch = 120;
		pinfo->ldi_updt.h_pulse_width = 8;
		pinfo->ldi_updt.v_back_porch = 30;
		pinfo->ldi_updt.v_front_porch = 10;
		pinfo->ldi_updt.v_pulse_width = 10;
		pinfo->fps_updt = 60;
