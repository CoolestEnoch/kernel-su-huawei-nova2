...
typedef unsigned short GPIO_NUM_TYPE;
...
struct gyro_platform_data {
	...
	uint8_t temp_compens_in_offset;
...
struct pseudo_sar_platform_data {
	struct sensor_combo_cfg cfg;
};
...
extern int rpc_motion(uint16_t  motion);
