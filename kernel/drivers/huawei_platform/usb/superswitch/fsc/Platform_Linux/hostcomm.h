...
#define CMD_DEVICE_LOCAL_REGISTER_READ  0xB0 /* BX designation for auto tests */
...
#define TEST_FIRMWARE                   0X01 /* For GUI ID of firmware */
...
*                       outBuf[2]: Number of times the timer ticker rolled over
* Return:          none
