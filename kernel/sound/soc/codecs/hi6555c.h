...
#define    HI6555C_CODEC_16BIT_SETTING  (0x3C3C0000)
...
#define HI6555C_PMU_CODEC_CLASSD_CTRL1_ADDR             ((PAGE_PMUCTRL) + (0x13C))
#define    HI6555C_PMU_CLASSD_CTRL1_I_PUMP_BIT  (0)
#define    HI6555C_PMU_CLASSD_CTRL1_P_SEL_BIT   (2)
#define    HI6555C_PMU_CLASSD_CTRL1_N_SEL_BIT   (4)

#define HI6555C_SMT_BUCK3_VSET                        ((PAGE_PMUCTRL) + (0x03D))
#define    HI6555C_SMT_BUCK3_VSET_BIT_START  (0)
...
struct hi6555c_priv {
	...
	struct workqueue_struct *classk_enable_dwq; /* extern classk enable work queue */
	struct delayed_work classk_enable_dw;
...
#define CLASSD_5500mV_VOL        5500      /* here we set 5.5V as the max value */
