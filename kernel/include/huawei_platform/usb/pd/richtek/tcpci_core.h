...
#define TYPEC_INFO_ENABLE	1///1
#define PE_EVENT_DBG_ENABLE	1///1
#define PE_STATE_INFO_ENABLE	1///1
#define TCPC_INFO_ENABLE	1///1
#define TCPC_TIMER_DBG_EN	0
#define TCPC_TIMER_INFO_EN	 1///1
#define PE_INFO_ENABLE		1///1
#define TCPC_DBG_ENABLE		0
#define DPM_DBG_ENABLE		1///1
#define PD_ERR_ENABLE		1///1
#define PE_DBG_ENABLE		0
#define TYPEC_DBG_ENABLE	1///1

#define DP_INFO_ENABLE		1///1
#define DP_DBG_ENABLE		1///1

#define UVDM_INFO_ENABLE		1///1
...
#define RT_DBG_ERR      pd_dbg_info
#else
#define RT_DBG_INFO	    hwlog_info
#define RT_DBG_ERR      hwlog_err
